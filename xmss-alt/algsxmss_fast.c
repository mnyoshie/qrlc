                    ...
                    uint32_t new_idx)
{
    ...
    {
        fprintf(stderr, "algsxmss_fast.c: index too high\n");
        return 1;
    }

    if (new_idx<current_idx)
    {
        fprintf(stderr, "algsxmss_fast.c: cannot rewind\n");
        return 1;
    }
    ...
    sk[0] = (uint8_t)(((new_idx) >> 24) & 255);
    sk[1] = (uint8_t)(((new_idx) >> 16) & 255);
    sk[2] = (uint8_t)(((new_idx) >> 8) & 255);
    sk[3] = (uint8_t)((new_idx) & 255);
