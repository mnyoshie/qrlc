#ifndef QDEV_CONFIG_H
#define QDEV_CONFIG_H
...
#define QHARD_FORK_HEIGHT0 942375
#define QHARD_FORK_HEIGHT1 1938000
#define QHARD_FORK_HEIGHT2 2078800
...
#define QBLOCK_MINING_NONCE_OFFSET 39
#define QBLOCK_EXTRA_NONCE_OFFSET 43
#define QMINING_BLOB_SIZE 76

#define QTRANSACTION_MULTI_OUTPUT_LIMIT 1000
...
extern qvec_t qget_banned_address(qu64 i);
#endif
